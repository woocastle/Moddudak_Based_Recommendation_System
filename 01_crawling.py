...
place = ['서울']
# category = ['정형외과', '마취통증의학과', '신경외과',
#             '재활의학과', '영상의학과', '외과', '신경과', '소아과', '내과', '이비인후과', '가정의학과', '한의원']          #'피부과', '성형외과', '산부인과', '정신건강의학과', '비뇨기과',
category = ['비뇨기과']
pages = [45]     # 183,  [85, 66, 55, 46, 108, 65, 25, 31, 25, 51, 13, 81, 204, 93, 69, 379]
...
for i in place:
    for j in category:
        ...
        for k in range(11, pages[idx-1]):
            ...
            reviews = []
            try :
                for hospitals_name in range(6, 14):
                    driver.get(url)  # 페이지 열기
                    time.sleep(0.1)
                    # 병원 이름 클릭
                    hospitals_name_xpath1 = '/html/body/div[3]/div/div/div[1]/div[3]/div[{}]/a/div/div[2]/div[2]/div[1]/div[1]/div[1]'.format(hospitals_name)
                    hospitals_name_xpath2 = '/html/body/div[3]/div/div/div[1]/div[3]/div[{}]/a/div/div[2]/div[2]/div[1]/div/div[1]'.format(hospitals_name)
                    try:
